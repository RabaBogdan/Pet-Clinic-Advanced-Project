...
public class ConsultService {
    ...
    private static final ConsultDao consultDao = new ConsultDao();
    private static final VeterinarianDao veterinarianDao1 = new VeterinarianDao();
    private static final VeterinarianService veterinarianService = new VeterinarianService();
    private static final PetDao petDao1 = new PetDao();
